...
public class AddEmployee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username=(EditText)findViewById(R.id.editText94);
        pass=(EditText)findViewById(R.id.editText95);
        confirmpass=(EditText)findViewById(R.id.editText96);
        mDatabase = FirebaseDatabase.getInstance().getReference();
        b=(Button)findViewById(R.id.button97);
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AddEmployee.this,"Password do not match",Toast.LENGTH_SHORT).show();
                }
                if(!p.equals("")) {
                    mDatabase.child("employees").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Intent i=new Intent(AddEmployee.this,ShowOnlyEmployees.class);
                            startActivity(i);
                            finish();
                        }
